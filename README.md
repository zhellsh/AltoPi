...
# Can I Help?
Why yes! Follow the instructions in the [Contributing](contribute.md) file.

# Where is the OS?
The base AltOS image is where all of the AltoPi's are flashed from.
The nightly, canary, stable, and old versions are also stored here.
You can find all of the different versions [here!](https://www.github.com/tired-tux/AltOS)
# License
